    ...
    return (
        <div >
            ...
            <Card className="text-center">
                ...
                <Card.Body>
                <Card.Title style={{fontSize:"30px"}}> Hardware Engineering Intern - Reliability & Test Design @ Tesla. Inc </Card.Title>
                <Card.Text style={{fontSize:"20px"}}>
                    <p> May - Sept 2022</p>
                    <p> I validated low voltage electronic modules on the Tesla semi-truck through risk assessment & DFMEA (design failure modes & effects analysis). I held circuit schematic & firmware design reviews with design & test teams to create reliability test designs with accelerated lifetime models, such as Arrhenius, Norris-Landzberg, Hallberg-Peck...etc. I also helped create functional & environmental stress scripts in Python to ensure durability of electronic units in Python & uncover/analyzed any occurrences of failure. </p>
                    <p> I created auto-grade qualification & reliability test plans for suppliers from 2 companies for Tesla consumer electronic modules. Participated in mechanical & assembly material & risk reviews, I drove test execution to ensure product functionality over designed warranty lifetime. 
                    </p>
                </Card.Text>
                </Card.Body>
            </Card>
            ...
            <Card className="text-center">
                ...
                <Card.Body >
                <Card.Title style={{fontSize:"30px"} }> Hardware Engineering Intern - Reliability & Data Analysis @ Cruise (GM) </Card.Title>
                <Card.Text style={{fontSize:"20px"}}>
                    <p> May - Aug 2021</p>
